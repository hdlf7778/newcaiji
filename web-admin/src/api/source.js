...
export const sourceApi = {
  ...
  batchCreate: (items) => request.post('/api/sources/batch-create', items),
  ...
  retire: (id) => request.post(`/api/sources/${id}/retire`),
  ...
  diagnose: (id) => request.post(`/api/sources/${id}/diagnose`),
  autoRepair: (id) => request.post(`/api/sources/${id}/auto-repair`),
  manualAssistRepair: (id, hint) => request.post(`/api/sources/${id}/manual-assist-repair`, { hint }),
}
